...
|
*/
// Switch sess_driver to 'database' after Phase 1.3 (schema applied, ci_sessions table exists)
...
// Override encryption_key (and optionally base_url) from gitignored secrets file
